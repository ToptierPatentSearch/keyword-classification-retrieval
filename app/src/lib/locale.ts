...
export const messages = {
  en: {
    ...
    currentPlanDescription: 'Your active paid pack is ready to use.',
    currentPlanLabel: 'Current plan',
    currentPlanName: (planName: string, currency: string) => `${planName} ${currency}`,
    planLoading: 'Loading your current plan and credits…',
    planLoadError: 'Unable to load your current plan and credits.',
  },
  ja: {
    ...
    currentPlanHeading: '現在のプラン',
    currentPlanDescription: '有効な購入済みパックを利用できます。',
    currentPlanLabel: '現在のプラン',
    currentPlanName: (planName: string, currency: string) => `${planName} ${currency}`,
    planLoading: '現在のプランとクレジットを読み込み中…',
    planLoadError: '現在のプランとクレジットを読み込めませんでした。',
  },
} as const;
