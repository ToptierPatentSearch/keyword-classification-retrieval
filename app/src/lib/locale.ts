...
export const messages = {
  en: {
    ...
    creditStateLoading: 'Loading your current plan...',
    creditStateError: 'Unable to load current credit status.',
    unknownPlan: 'Purchased Pack',
  },
  ja: {
    ...
    currentPlanStatus: '現在のプラン状況',
    currentPlan: '現在のプラン',
    currency: '通貨',
    expires: '有効期限',
    creditStateLoading: '現在のプランを読み込み中...',
    creditStateError: '現在のクレジット状況を読み込めませんでした。',
    unknownPlan: '購入済みパック',
  },
} as const;
